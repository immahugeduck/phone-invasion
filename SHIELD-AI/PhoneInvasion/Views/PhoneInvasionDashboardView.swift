// PhoneInvasionDashboardView.swift
// Main scan UI and threat summary dashboard view

import SwiftUI

struct PhoneInvasionDashboardView: View {
...
struct PhoneInvasionDashboardView_Previews: PreviewProvider {
    static var previews: some View {
        PhoneInvasionDashboardView()
    }
}
